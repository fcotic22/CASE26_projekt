...
namespace CASE26_projekt
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\user\Desktop\CASE_2026_projekt\logoviElektraneNikola\MIKULIĆ.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Forecasting.ForecastBySsa(windowSize:722,seriesLength:2072,trainSize:44276,horizon:10,outputColumnName:@"Daily energy(kWh)",inputColumnName:@"Daily energy(kWh)",confidenceLowerBoundColumn:@"Daily energy(kWh)_LB",confidenceUpperBoundColumn:@"Daily energy(kWh)_UB");
